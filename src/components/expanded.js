    ...
    <ExpansionPanel>
      ...
      <ExpansionPanelDetails>
          <Grid container spacing={1} direction="row">
            <Grid item xs={12}>
              <Button variant='outlined' color="primary" onClick={() => onAdd()}>Add</Button>
            </Grid>
            {list.map((item,i) => 
              <CustomPaper style={{width:"100%", margin:"0.25rem", padding:"0.7rem"}} variant="outlined" key={i}>
                ...
                <Button color="secondary" onClick={() => onDelete(i)}>Delete</Button>
              </CustomPaper>
            )} 
          </Grid>           
      </ExpansionPanelDetails>
